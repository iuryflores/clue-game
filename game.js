...
//Gerts random intem from each array and constructs the mystery
...
let mystery = pickMystery(); // Who killed Mr. Boddy with what ins which room...

//console.log(mystery.suspect.name, mystery.weapon.name, mystery.room.name)

//console.log(Math.floor(Math.random() * 5)) //Random number between 0 and 5
